...
-- Library functions 
    ...
    -- Library element functions
        ...
        function Library:Dropdown(properties) 
                ...
                -- Element Holder
                    ...
                    if Cfg.Search then 
                        ...
                        Items.Value = Library:Create( "TextBox", {
                            ...
                            AutomaticSize = Enum.AutomaticSize.XY;
                            BackgroundColor3 = rgb(255, 255, 255)
                        });	Library:Themify(Items.Value, "unselected", "BackgroundColor3")
                    end 
            ...
            Items.Value:GetPropertyChangedSignal("Text"):Connect(function()
                Cfg.Filter(Items.Value.Text)
            end)
...
local Holder = Library:Window({Name = "joyce.noob"})
...
local Sides = {"Left", "Bottom", "Top", "Right"}
task.spawn(function()
    while Esp do 
        for _,player in Players:GetPlayers() do 
